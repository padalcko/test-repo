...
document.addEventListener("DOMContentLoaded", () => {
  ...
  /* ==========================================================
     12. PRIVACY SETTINGS PLACEHOLDER
     ========================================================== */

  if (privacySettingsButton) {
    privacySettingsButton.addEventListener("click", () => {
      /*
          Docelowo podpinamy tutaj panel CMP / cookies.

          Nie tworzymy fałszywego panelu prywatności,
          dopóki nie wybierzemy rozwiązania.
        */

      console.info("LTS Market: privacy settings module is not connected yet.");
    });
  }
